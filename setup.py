...
PLUGIN_ENTRY_POINT = 'skill-ovos-application-launcher.openvoiceos=skill_application_launcher:ApplicationLauncherSkill'
...
setup(
    ...
    url='https://github.com/OpenVoiceOS/skill-ovos-application-launcher',
    author='JarbasAi',
